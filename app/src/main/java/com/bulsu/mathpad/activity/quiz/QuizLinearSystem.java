...
public class QuizLinearSystem extends AppCompatActivity {
    ...
    public void onClick() {
        ...
        if (rb1c.isChecked())
            ...
            rb1c.setBackgroundColor(Color.RED);

        if (rb2a.isChecked())
            score++;
        else
            rb2a.setBackgroundColor(Color.RED);
        ...
        if (rb4c.isChecked())
            ...
            rb4c.setBackgroundColor(Color.RED);

        if (rb5a.isChecked())
            score++;
        else
            rb5a.setBackgroundColor(Color.RED);

        if (rb6a.isChecked())
            score++;
        else
            rb6a.setBackgroundColor(Color.RED);
        ...
        if (rb9c.isChecked())
            ...
            rb9c.setBackgroundColor(Color.RED);

        if (rb10b.isChecked())
            score++;
        else
            rb10b.setBackgroundColor(Color.RED);
