...
public class SolverDeterminant extends AppCompatActivity {
    TextView tv_ans;
    double[][] var;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solver_determinant);
    ...
    public void clearAllDeterminant2x2(View view)
    {
        for (int i =0; i< numbers1.size();i++)
        {
