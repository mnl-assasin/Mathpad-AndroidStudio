...
public class SolverInverse2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solver_inverse2);
        numbers1.clear();
        answer.clear();
    ...
    public void onClickSolveinverse3(View v) {
        ...
        try {
            RealMatrix a = new LUDecomposition(
                    MatrixUtils.createRealMatrix(new double[][] { { Double.parseDouble(numbers1.get(0).getText().toString()),  Double.parseDouble(numbers1.get(1).getText().toString()),  Double.parseDouble(numbers1.get(2).getText().toString())},
    ...
    public void clearInverse3(View v)
    {
        for (int i = 0; i < 9; i++) {
    ...
    public void clearAllInverse3(View v)
    {
