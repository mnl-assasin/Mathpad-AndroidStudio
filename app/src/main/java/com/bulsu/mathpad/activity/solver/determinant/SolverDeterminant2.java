...
public class SolverDeterminant2 extends AppCompatActivity {
    TextView tv_ans;
    double[][] var;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solver_determinant2);
    ...
    public void solve1(View v) {
        ...
        for (int i = 0; i < numbers1.size(); i++) {
            if (numbers1.get(i).getText().toString().equals("")) {
                Toast.makeText(SolverDeterminant2.this, "please fill up the blank spaces", Toast.LENGTH_SHORT).show();
                return;
            }
        }

        var = new double[][]
                {{Double.parseDouble(numbers1.get(0).getText().toString()), Double.parseDouble(numbers1.get(1).getText().toString()) , Double.parseDouble(numbers1.get(2).getText().toString())}
                        , {Double.parseDouble(numbers1.get(3).getText().toString()), Double.parseDouble(numbers1.get(4).getText().toString()), Double.parseDouble(numbers1.get(5).getText().toString())}
                        , {Double.parseDouble(numbers1.get(6).getText().toString()), Double.parseDouble(numbers1.get(7).getText().toString()), Double.parseDouble(numbers1.get(8).getText().toString())}};

        DecimalFormat df = new DecimalFormat("0");
        DecimalFormat df2 = new DecimalFormat("0.00");
        double answer1 = determinant(var);
        String ansText=""+answer1;
    ...
    public void clearAllDeterminant3x3(View view)
    {
        for (int i =0; i< numbers1.size();i++)
        {
